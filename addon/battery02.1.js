...
// =================== BATTERY02 CODE
// EXAMPLE: This creates the x-device 'ROMA test batterie' for device control
function BATTERY02(_b2xname = "ROMA test batterie", _b2xroom = "tools", _b2xhome = 'ADMIN') {
...
// So it is not allowed to change target home at runtime: all options are defined in the next line:
    ...
    var _power = [ 
	       {name: "alcalina_AA", count:0},    //  powID:0
		   ...
		   {name: "unknown", count:0},        //  powID:6
		   {name: "alcalina_9V", count:0},    //  powID:7
...
// non è prevista la modifica di home al runtime perchè dovrebbe variare di conseguenza anche  _devices[] 
	...
	//	 SETXDEVICESTATUS(_b2xname, "time", (new Date()).toTimeString().split(' ')[0]);
		 ...
		 VOICE("La lista delle batterie di ROMA è aggiornata");
	   }
  }
